...
**Gate** — corpus `…Raw` rate 63.6% ≥ target 15.0% → ❌ FAIL

- Datasets analysed: 12 (of 12 in corpus)
- Computed columns (function + `…Raw`): 11; of those, raw fallbacks: 7

## Per-dataset

| dataset | object maps | function | raw | direct | computed | `…Raw` rate |
|---|--:|--:|--:|--:|--:|--:|
| airports | 7 | 0 | 0 | 7 | 0 | n/a |
| cars | 9 | 0 | 0 | 9 | 0 | n/a |
| co2-concentration | 3 | 0 | 0 | 3 | 0 | n/a |
| crossref-works | 7 | 0 | 4 | 3 | 4 | 100.0% |
| disasters | 3 | 0 | 0 | 3 | 0 | n/a |
| earthquakes | 11 | 2 | 3 | 6 | 5 | 60.0% |
| gapminder | 6 | 0 | 0 | 6 | 0 | n/a |
| movies | 10 | 1 | 0 | 9 | 1 | 0.0% |
...
| boolean | 0 | 0 | 1 | 1 |
| doi | 0 | 0 | 1 | 0 |
| epoch_millis | 0 | 0 | 2 | 0 |
| messy_date | 2 | 0 | 0 | 0 |
| multivalue_or_json | 0 | 4 | 0 | 1 |
| url | 2 | 0 | 0 | 0 |
