...
「データの数えかた」の画面では、まず AI が読み取った「1 行 = 何か」が
合っているかを確かめます。次に、行ごとの ID が重ならないか（✓ / ⚠）を
見ます。どちらも問題なければ「この数えかたで進む」ボタンで次へ。読み取りが
違っていたら「AI にもう一度考えさせる」ボタンで指摘を伝え、⚠ が出ていれば
候補から選び直せます。読み取り自体をやめて前の画面に戻りたいときは
「戻ってやり直す」ボタンです。
...
できます。数えかたの決めかたをやり直したいときは「データの数えかたに戻る」
ボタンで 3. の画面に戻れます。
