...
その値が入っている列に ☑ を付けると、両方の列に ☑ が付いていて値が重なる
ときにかぎり、公開したときに自動で結ばれます。たとえばレシピの表と
スーパーの価格表の両方で食材名「にんじん」の列に ☑ を付けておけば、
「にんじんを使うレシピと、いまの値段」を一度に引けるようになります（☑ を
付けるのは列で、つながるのはその中の値です。結ばれたかどうかは「つながり」
画面で確かめられ、要らなければ外せます）。
