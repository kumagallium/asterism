...
サイドバーのメニューには専用の項目はありませんが、「全体像を見る」ボタン
から、どんなデータがあって、どうつながっているかを 1 枚の図で俯瞰できます。
外部の標準（よく使われる標準のことば）も、表示に含めて見ることができます。

![全体像を見るボタンから開いた俯瞰図](../screenshots/crosswalk-map.png)
