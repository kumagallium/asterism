...
# 相談チャット — 設計中の疑問を、画面を離れずに聞く <Badge type="tip" text="v0.20.0 (2026-08-25) で追加" />
...
## いま見ている画面のことは、伝えなくても伝わる <Badge type="tip" text="v0.21.0 (2026-08-25) で追加" />

かんたんモードのウィザードの途中で開くと、いまのステップ・データセット名・
表の数えかたの要約が自動で AI に伝わります。「意味をつける」の画面では、
...
## AI の候補を表に反映する <Badge type="tip" text="v0.21.0 (2026-08-25) で追加" />

「意味をつける」や「データの数えかた」の画面で相談していて、AI が列の意味・
