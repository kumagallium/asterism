...
# here so existing ``from asterism.starrydata import slugify`` call sites (this
# module's emitters, the watcher, tests) keep working unchanged.
...
# slugify / parse_issued moved to asterism.text (#20 P2) — re-exported above.
...
# parse_float_array / strip_quoted / safe_url (+ IRI-sanitization constants)
# moved to asterism.text (#20 P2) — re-exported above.
