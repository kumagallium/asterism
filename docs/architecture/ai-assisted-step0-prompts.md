...
4. `ingest/src/asterism/{{dataset}}.py`    ← §3.8 Python skeleton 完成版
...
```
# Role
あなたは独立した検証 AI agent です。asterism が提供する MCP tools
...
- Phase 1 成果物例:
  ...
  - [`../../ingest/src/asterism/starrydata.py`](../../ingest/src/asterism/starrydata.py) — ingester の正解例
